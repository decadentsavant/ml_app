...
class AllEntriesBloc extends Bloc<AllEntriesEvent, AllEntriesState> {
  AllEntriesBloc({
    ...
    on<AllEntriesEntryIsActiveToggled>(_onEntryIsActiveToggled);
    on<AllEntriesFilterChanged>(_onFilterChanged);
    // TODO(Corey): Implement a route push with the entry
    // on<AllEntriesEntrySelected>(_onEntrySelected);
  }
  ...
  Future<void> _onSubscriptionRequested(
    ...
    emit(
      state.copyWith(
        status: () => AllEntriesStatus.loading,
      ),
    );
  ...
  Future<void> _onEntryIsActiveToggled(
    AllEntriesEntryIsActiveToggled event,
    Emitter<AllEntriesState> emit,
  ) async {
  ...
  Future<void> _onUndoDeletionRequested(
    ...
    assert(
        state.lastDeletedEntry != null, 'Last deleted entry can not be null.',);
  ...
  // TODO(Corey): Implement a route push with the entry
  // Future<void> _onEntrySelected() async {}
}
